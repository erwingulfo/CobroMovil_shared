package com.softdesignermonteria.cobromovil.listacobrodiario;
...
public class ListViewCobroDiarioArrayAdapter extends ArrayAdapter<ModelClientes> {
	...
	public ListViewCobroDiarioArrayAdapter(Context mContext,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			TextView txt1 = (TextView) convertView
					.findViewById(R.id.LbListaRecaudosClientes_id);
			txt1.setText(objectItem.getClientes_id());

			TextView txt2 = (TextView) convertView
					.findViewById(R.id.LbListaRecaudosCedula);
			txt2.setText(objectItem.getCedula());
			
			TextView txt3 = (TextView) convertView
					.findViewById(R.id.LbListaRecaudosValorRecaudado);
			txt3.setText(objectItem.getValor_recaudado());
			
			
			TextView txt6 = (TextView) convertView
					.findViewById(R.id.LbListaRecaudosNombres);
